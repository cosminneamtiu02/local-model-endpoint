...
| `task check` | Run lint, format, lockfile, types, architecture, coverage-gated tests, error contracts, plist, audit, secrets, plus the cross-workspace drift-guards (test-class regex sync, detect-secrets version sync, ruff version sync, dev-tool version sync) |
